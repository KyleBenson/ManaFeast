...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'donations_donation', (
            ...
            ('short_description', self.gf('django.db.models.fields.TextField')(max_length=50)),
            ('time_window_start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 1, 0, 0))),
            ('time_window_end', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 6, 2, 0, 0), null=True)),
            ('pickup', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('dropoff', self.gf('django.db.models.fields.BooleanField')(default=True)),
