...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Donation.food_type'
        db.add_column(u'donations_donation', 'food_type',
                      self.gf('django.db.models.fields.CharField')(default='produce', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Donation.food_type'
        db.delete_column(u'donations_donation', 'food_type')
